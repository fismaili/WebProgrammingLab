<header class="bg-blue-900 text-white p-4">
  <div class="container mx-auto flex justify-between items-center">
    ...
    <nav class="hidden md:flex items-center space-x-4">
      ...
      <a href="{{ url('/job/saved') }}" class="text-white hover:underline py-2"
        >Saved Jobs</a
      >
  ...
  >
    <a href="{{ url('/job') }}" class="block px-4 py-2 hover:bg-blue-700"
      >All Jobs</a
    >
    <a href="{{ url('/job/saved') }}" class="block px-4 py-2 hover:bg-blue-700"
      >Saved Jobs</a
    >
